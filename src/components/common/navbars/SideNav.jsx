          ...
          <a href="#" className="nav-link nav-link-side bg-transparent nav-logo py-3 d-flex align-items-center justify-content-center m-auto p-0  h-6 w-6 text-decoration-none"  data-bs-toggle="tooltip" data-bs-placement="right"
            ...
            <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                ...
                stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M19.7656 10.7812V9.70312" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
              <path d="M18.5172 11.5L17.5918 10.9609" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
              <path d="M18.5172 12.9375L17.5918 13.4766" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
              <path d="M19.7656 13.6562V14.7344" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
              <path d="M21.0137 12.9375L21.9391 13.4766" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
              <path d="M21.0137 11.5L21.9391 10.9609" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                strokeLinejoin="round" />
            </svg>
          </a>
        </li>
