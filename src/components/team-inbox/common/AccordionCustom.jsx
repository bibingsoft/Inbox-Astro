  ...
  return (
      <div className="sidebar">
          <div className="accordion accordion-custom-right mt-2" id={props.id}>
                      <div className="accordion-item acc-card bg-white border-0 rounded mb-3 p-2 fs-6 position-relative">
                        <div className="accordion-header bg-white" id="headingUpdate">
                          <a className="accordion-button collapsed head d-flex align-items-center bg-white" type="button"
                            ...
                            <div className="d-flex align-items-center">
                              <div className="d-flex align-items-center justify-content-center me-3 rounded-circle overflow-hidden"><img src={props.image}/></div>
