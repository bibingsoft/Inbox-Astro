...
function chatLeft({ username, time, chatCustomer }) {
    return (
        <div className="chat-left">
                                  <div className="d-flex flex-row chat-flex">
                                    <div className="user-ico-div ">
                                      <div className="user-chat-ico d-flex align-items-center justify-content-center rounded-circle bg-light-grey me-1">
                                    ...
                                    <div className="d-flex flex-column pt-1">
                                      <div className="name d-block">{username}, {time}</div>
                                      <div className="d-flex mt-2  align-items-start">
            
                                        <div className="chat-cvr d-flex align-items-start flex-column w-100">
                                          <div className="box-blue d-flex flex-column align-items-end gap-2 mb-1">
